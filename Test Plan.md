# **Inbox Mover \- Comprehensive Test Plan (v0.9.7)**

## **1\. Introduction**

**Objective:** To verify that Inbox Mover v0.9.7 successfully processes transfer-\* folders, extracts ZIP archives, handles receipt.json updates, dynamically generates local logs, manages the modern UI, resolves file conflicts, handles pattern matching, and reliably supports keyboard navigation.
...
| :---- | :---- | :---- | :---- |
| UI-01 | Launch inbox\_mover.py | App opens with default size (1100x950), Dark Mode enabled. Version reads 0.9.7. Modern "Card" layout is visible. |  |
...
## **5\. Local Logging & Receipt Injection (v0.9.7 Features)**
...
| CLI-01 | Open terminal. Run: python inbox\_mover.py \--cli \--help | Displays help menu with all available arguments, confirming v0.9.7. |  |
